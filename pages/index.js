    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        ...
        {!isLoading && !nfts.length ? (
          ...
          <>
            <div>
              <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">User Creators
              </h1>
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                <h1 className="flex-1 font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold sm:mb-4">Explore NFTs</h1>
