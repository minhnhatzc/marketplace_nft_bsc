...
const subdomainName = 'nftsmarketplace';
const projectId = '2PxqhOaId3ioLwNbQLOr8HvYGnU';
const projectSecret = 'e04fce746cd5a7bddbf452e3862cc921';
...
export const NFTProvider = ({ children }) => {
  ...
  const fetchNFTs = async () => {
    ...
    const provider = new ethers.providers.JsonRpcProvider('https://polygon-mumbai.g.alchemy.com/v2/qfIyPdk21mQrhqs4pfZhvMU6pHKtSv-J');
